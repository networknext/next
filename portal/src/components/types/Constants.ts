...
export const SDK_DOWNLOAD_URL = 'https://storage.googleapis.com/portal_sdk_download_storage/next-4.20.4.zip'
...
export const UE4_PLUGIN_SOURCE_URL = 'https://github.com/networknext/ue4'
export const UE4_PLUGIN_SOURCE_EVENT = 'ue4-source-view'
export const UNITY_PLUGIN_DOWNLOAD_URL = 'https://storage.googleapis.com/network-next-unity/next-unity.unitypackage'
export const UNITY_PLUGIN_DOWNLOAD_EVENT = 'unity-download'
export const UNITY_PLUGIN_SOURCE_URL = 'https://github.com/networknext/unity'
export const UNITY_PLUGIN_SOURCE_EVENT = 'unity-source-view'
export const ENET_DOWNLOAD_URL = 'https://storage.googleapis.com/network-next-enet/ENet.zip'
export const ENET_DOWNLOAD_EVENT = 'enet-download'
export const ENET_SOURCE_URL = 'https://github.com/networknext/enet'
export const ENET_SOURCE_EVENT = 'enet-source-view'
