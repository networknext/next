...
describe('SessionDetails.vue', () => {
  ...
  it('checks meta data fields - !admin - sameBuyer', async () => {
    ...
    expect(metaTitles.at(1).text()).toBe('ISP')
    expect(metaTitles.at(2).text()).toBe('User Hash')
    expect(metaTitles.at(3).text()).toBe('Client IP Address')
    expect(metaTitles.at(4).text()).toBe('Server IP Address')
    expect(metaTitles.at(5).text()).toBe('Platform')
    expect(metaTitles.at(6).text()).toBe('Customer')
    expect(metaTitles.at(7).text()).toBe('SDK Version')
    expect(metaTitles.at(8).text()).toBe('Connection Type')
    ...
    expect(metaData.at(4).text()).toBe('127.0.0.1')
    expect(metaData.at(5).text()).toBe('Linux')
    expect(metaData.at(6).text()).toBe('Test Company')
    expect(metaData.at(7).text()).toBe('4.0.16')
    expect(metaData.at(8).text()).toBe('Wired')
  ...
  it('checks meta data fields - admin - !live', async () => {
    ...
    expect(metaTitles.at(7).text()).toBe('SDK Version')
    expect(metaTitles.at(8).text()).toBe('Connection Type')
    expect(metaTitles.at(9).text()).toBe('Route')
    ...
    expect(metaData.at(7).text()).toBe('4.0.16')
    expect(metaData.at(8).text()).toBe('Wired')
    expect(metaData.at(9).text()).toBe('Customer is not live')
  ...
  it('checks meta data fields - admin - live - no near relays', async () => {
    ...
    expect(metaData.at(7).text()).toBe('4.0.16')
    expect(metaData.at(8).text()).toBe('Wired')
    expect(metaData.at(9).text()).toBe('No Near Relays')
  ...
  it('checks meta data fields - admin - live', async () => {
    ...
    const metaTitles = wrapper.findAll('dt')
    expect(metaTitles.length).toBe(11)
