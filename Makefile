...
.PHONY: build-all
build-all: build-sdk build-portal-cruncher build-analytics build-api build-vanity build-billing build-beacon build-beacon-inserter build-relay-backend build-relay-pusher build-server-backend build-reference-relay build-client build-server build-functional build-next ## builds everything
