...
namespace testing
{
	...
	void Test_Address_parse_additional()
	{
		net::Address addr;
		...
		{
			check(addr.parse("[fe80::202:b3ff:fe1e:8329]:40000") == RELAY_OK);
			check(addr.Type == net::AddressType::IPv6);
			check(addr.Port == 40000);
			check(addr.IPv6[0] == 0xfe80);
			check(addr.IPv6[1] == 0x0000);
		...
		{
			check(addr.parse("[::]:40000") == RELAY_OK);
			check(addr.Type == net::AddressType::IPv6);
			check(addr.Port == 40000);
			check(addr.IPv6[0] == 0x0000);
			check(addr.IPv6[1] == 0x0000);
		...
		{
			check(addr.parse("[::1]:40000") == RELAY_OK);
			check(addr.Type == net::AddressType::IPv6);
			check(addr.Port == 40000);
			check(addr.IPv6[0] == 0x0000);
			check(addr.IPv6[1] == 0x0000);
