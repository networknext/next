...
namespace core
{
  ...
  void PingProcessor::process(std::condition_variable& var, std::atomic<bool>& readyToSend)
  {
    ...
    GenericPacketBuffer<MaxPacketsToSend, packets::NewRelayPingPacket::ByteSize> buffer;
  ...
  void PingProcessor::processV3(std::condition_variable& var, std::atomic<bool>& readyToSend)
  {
    readyToSend = true;
    var.notify_one();
    GenericPacketBuffer<MaxPacketsToSend, packets::NewRelayPingPacket::ByteSize> buffer;
