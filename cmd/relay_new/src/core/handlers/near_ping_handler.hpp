...
namespace core
{
  namespace handlers
  {
    ...
    {
     public:
      NearPingHandler(GenericPacket<>& packet, const net::Address& from, const os::Socket& socket, util::ThroughputRecorder& recorder, legacy::v3::TrafficStats& stats);
    ...
    inline NearPingHandler::NearPingHandler(
     GenericPacket<>& packet, const net::Address& from, const os::Socket& socket, util::ThroughputRecorder& recorder, legacy::v3::TrafficStats& stats)
