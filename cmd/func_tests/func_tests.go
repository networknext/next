...
func test_multipath_next_packet_loss() {
	...
	relayConfig := RelayConfig{
		...
		fake_packet_loss_start_time: 30.0,
	}
	...
	// todo: hack test
	client_check(client_counters, client_stdout, server_stdout, backend_stdout, false)
...
func test_idempotent() {
	...
	backend_cmd, backend_stdout := backend("IDEMPOTENT")
