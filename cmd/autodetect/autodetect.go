...
func main() {
	...
	patternString := envvar.GetString("AUTODETECT_PATTERNS", "maxihost,latitude|latitude,latitude|i3d,i3d|gcore,gcore|g-core,gcore|datacamp,datacamp|velia,velia|uk2group,uk2group|hivelocity,hivelocity|servers.com,serversdotcom|ovh,ovh|")
