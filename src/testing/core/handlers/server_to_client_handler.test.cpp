...
Test(core_handlers_server_to_client_handler_sdk4_unsigned)
{
  Packet packet;
  SessionMap map;
  ...
  core::handlers::server_to_client_handler_sdk4(packet, map, recorder, router_info, socket, false);
...
Test(core_handlers_server_to_client_handler_sdk4_signed)
{
  Packet packet;
  SessionMap map;
  ThroughputRecorder recorder;
  ...
  core::handlers::server_to_client_handler_sdk4(packet, map, recorder, router_info, socket, true);
