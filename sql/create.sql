...
CREATE TABLE route_shaders (
  ...
  primary key (id),
  constraint route_shader_short_name_constraint unique(short_name)
);
...
CREATE TABLE buyers (
  ...
  constraint fk_route_shader_id foreign key (route_shader_id) references route_shaders(id),
  constraint buyer_short_name_constraint unique(short_name)
);
...
CREATE TABLE sellers (
  ...
  primary key (id),
  constraint fk_customer_id foreign key (customer_id) references customers(id),
  constraint seller_short_name_constraint unique(short_name)
);
...
CREATE TABLE datacenters (
  ...
  constraint datacenter_display_name_constraint unique(display_name)
);
...
CREATE TABLE relays (
  ...
  constraint relay_display_name_constraint unique(display_name),
