...
func sendAnalyticsSessionSummaryMessage(state *SessionUpdateState) {
	...
	message.SDKVersion_Minor = byte(state.Request.Version.Minor)
	message.SDKVersion_Patch = byte(state.Request.Version.Patch)
	message.ClientToServerPacketsSent = state.Input.PacketsSentClientToServer
	message.ServerToClientPacketsSent = state.Input.PacketsSentServerToClient
	message.ClientToServerPacketsLost = state.Input.PacketsLostClientToServer
	message.ServerToClientPacketsLost = state.Inpu.PacketsLostServerToClient
	message.ClientToServerPacketsOutOfOrder = state.Input.PacketsOutOfOrderClientToServer
	message.ServerToClientPacketsOutOfOrder = state.Input.PacketsOutOfOrderServerToClient
