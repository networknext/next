...
func Test_SessionUpdate_BuildNextTokens_PrivateAddresses_OnlyIfBothHaveInternalAddresses(t *testing.T) {
	...
	relay_c := db.Relay{Id: 3, Name: "c", PublicAddress: relay_address_c, InternalAddress: relay_address_c_internal, HasInternalAddress: true, Seller: seller, PublicKey: relay_public_key_c}
...
func Test_SessionUpdate_BuildNextTokens_PrivateAddresses_AllHaveInternalAddresses(t *testing.T) {
	...
	relay_a := db.Relay{Id: 1, Name: "a", PublicAddress: relay_address_a, InternalAddress: relay_address_a_internal, HasInternalAddress: true, Seller: seller, PublicKey: relay_public_key_a}
	relay_b := db.Relay{Id: 2, Name: "b", PublicAddress: relay_address_b, InternalAddress: relay_address_b_internal, HasInternalAddress: true, Seller: seller, PublicKey: relay_public_key_b}
	relay_c := db.Relay{Id: 3, Name: "c", PublicAddress: relay_address_c, InternalAddress: relay_address_c_internal, HasInternalAddress: true, Seller: seller, PublicKey: relay_public_key_c}
