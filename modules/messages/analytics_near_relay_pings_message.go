...
const (
	AnalyticsNearRelayPingsMessageVersion_Min   = 1
	AnalyticsNearRelayPingsMessageVersion_Max   = 1
	AnalyticsNearRelayPingsMessageVersion_Write = 1
)
...
func (message *AnalyticsNearRelayPingsMessage) Write(buffer []byte) []byte {
	...
	if message.Version < AnalyticsNearRelayPingsMessageVersion_Min || message.Version > AnalyticsNearRelayPingsMessageVersion_Max {
...
func (message *AnalyticsNearRelayPingsMessage) Read(buffer []byte) error {
