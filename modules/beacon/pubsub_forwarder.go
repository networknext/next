...
func NewPubSubForwarder(ctx context.Context, beaconer Beaconer, logger log.Logger, metrics metrics.ReceiverMetrics, gcpProjectID string, topicName string, subscriptionName string) (*PubSubForwarder, error) {
