...
const (
	...
	// IMPORTANT: Update Serialize() and Validate() in modules/billing/billing_entry.go when a new connection type is added
	...
	// IMPORTANT: Update Serialize() and Validate() in modules/billing/billing_entry.go when a new platform type is added
