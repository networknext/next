...
const (
	...
	PacketTypeServerInitRequest5  = 50
	PacketTypeServerInitResponse5 = 51
	PacketTypeServerUpdate5       = 52
	PacketTypeServerResponse5     = 53
	PacketTypeSessionUpdate5      = 54
	PacketTypeSessionResponse5    = 55
...
func MarshalPacket5(packetType int, packetObject Packet, from *net.UDPAddr, to *net.UDPAddr, privateKey []byte) ([]byte, error) {
...
type ServerInitRequestPacket5 struct {
	Version      SDKVersion
	RequestID    uint64
	BuyerID      uint64
	DatacenterID uint64
...
func (packet *ServerInitRequestPacket5) Serialize(stream encoding.Stream) error {
	versionMajor := uint32(packet.Version.Major)
	versionMinor := uint32(packet.Version.Minor)
	versionPatch := uint32(packet.Version.Patch)
	stream.SerializeBits(&versionMajor, 8)
...
type ServerInitResponsePacket5 struct {
	RequestID     uint64
	Response      uint32
...
func (packet *ServerInitResponsePacket5) Serialize(stream encoding.Stream) error {
	stream.SerializeUint64(&packet.RequestID)
	stream.SerializeBits(&packet.Response, 8)
...
type ServerUpdatePacket5 struct {
	Version       SDKVersion
	RequestID     uint64
	BuyerID       uint64
	DatacenterID  uint64
...
func (packet *ServerUpdatePacket5) Serialize(stream encoding.Stream) error {
	versionMajor := uint32(packet.Version.Major)
	versionMinor := uint32(packet.Version.Minor)
	versionPatch := uint32(packet.Version.Patch)
	stream.SerializeBits(&versionMajor, 8)
...
type ServerResponsePacket5 struct {
	RequestID     uint64
	UpcomingMagic [8]byte
	CurrentMagic  [8]byte
	PreviousMagic [8]byte
...
type SessionUpdatePacket5 struct {
	Version                         SDKVersion
	BuyerID                         uint64
	DatacenterID                    uint64
	SessionID                       uint64
...
type SessionResponsePacket5 struct {
	Version            SDKVersion
	SessionID          uint64
	SliceNumber        uint32
	SessionDataBytes   int32
...
func (packet *SessionResponsePacket5) Serialize(stream encoding.Stream) error {
...
func (sessionData *SessionData5) Serialize(stream encoding.Stream) error {
