...
func TestRouteMatrix4Serialize(t *testing.T) {
	expected := getRouteMatrix4(t)
	...
	var actual routing.RouteMatrix4
...
func TestRouteMatrix4NoNearRelays(t *testing.T) {
...
func TestRouteMatrix4GetNearRelaysSuccess(t *testing.T) {
	routeMatrix := getRouteMatrix4(t)
...
func TestRouteMatrix4GetNearRelaysSuccessWithMax(t *testing.T) {
	routeMatrix := getRouteMatrix4(t)
...
func TestRouteMatrix4GetDatacenterIDsEmpty(t *testing.T) {
	routeMatrix := getRouteMatrix4(t)
...
func TestRouteMatrix4GetDatacenterIDsSuccess(t *testing.T) {
	routeMatrix := getRouteMatrix4(t)
