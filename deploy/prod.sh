...
do
    printf "\n\nInstance: ${INSTANCE}...\n\n"
    gcloud compute --project "network-next-v3-prod" ssh ${INSTANCE} -- "sudo sysctl -w net.core.rmem_max=1000000000 && sudo systemctl restart app" # "cd /app && sudo ./vm-update-app.sh -a ${ARTIFACT}"
done
printf "\ndone\n"