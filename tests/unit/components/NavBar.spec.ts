...
describe('NavBar.vue', () => {
  ...
  it('checks nav links - anonymous', () => {
    ...
    expect(links.at(1).text()).toBe('Saves')
    expect(links.at(2).text()).toBe('Sessions')
    expect(links.at(3).text()).toBe('Session Tool')
  ...
  it('checks nav links - anonymousPlus', () => {
    ...
    expect(links.at(2).text()).toBe('Sessions')
    expect(links.at(3).text()).toBe('Session Tool')
    expect(links.at(4).text()).toBe('User Tool')
  ...
  it('checks nav links - !anonymous - !anonymousPlus - !explorer', () => {
    ...
    expect(links.at(3).text()).toBe('Session Tool')
    expect(links.at(4).text()).toBe('User Tool')
    expect(links.at(5).text()).toBe('Downloads')
  ...
  it('checks nav links - !anonymous - !anonymousPlus - explorer', () => {
    ...
    expect(links.at(5).text()).toBe('Downloads')
    expect(links.at(6).text()).toBe('Settings')
    expect(links.at(7).text()).toBe('Usage')
