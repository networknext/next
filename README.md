...
Network Next is source available and free to use when you host the software for your own game with less than 10k peak CCU. For games with 10k peak CCU please contact us for pricing details. We also offer a hosted solution with commercial support. Please [contact us](mailto:glenn@networknext.com) for details.
