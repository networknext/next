...
You control the settings to decide when to accelerate your players. Set acceptable latency, jitter and packet loss values for your game, and how much latency reduction is needed before accelerating a player.
