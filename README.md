...
6. Install Go (must be 1.18+)
	`cd /usr/local/`
	Linux: `sudo curl https://dl.google.com/go/go1.19.3.linux-amd64.tar.gz | sudo tar -zxv`
	Mac: `sudo curl https://dl.google.com/go/go1.19.3.darwin-amd64.pkg | sudo tar -zxv`
