...
## Copy the entire **NetworkNext** folder into your **Plugins** directory.

## Add the following to the bottom of *Config/DefaultEngine.ini*
...
## Edit the blueprint on your game mode to call "UpgradePlayer" in response to the OnPostLogin event
