...
var prodRelayMap = map[string][]string{
	"amazon.saopaulo.1": {"amazon.saopaulo.1", "m5a.2xlarge", "ubuntu/images/hvm-ssd/ubuntu-jammy-22.04-amd64-server-*"},
	"amazon.saopaulo.2": {"amazon.saopaulo.2", "m5a.2xlarge", "ubuntu/images/hvm-ssd/ubuntu-jammy-22.04-amd64-server-*"},
	"amazon.saopaulo.3": {"amazon.saopaulo.3", "m5a.2xlarge", "ubuntu/images/hvm-ssd/ubuntu-jammy-22.04-amd64-server-*"},
}
