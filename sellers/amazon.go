...
var prodRelayMap = map[string][]string{
	...
	*/
	...
	"amazon.lima.1":        {"amazon.lima.1", "r5.large", "ubuntu/images/hvm-ssd/ubuntu-jammy-22.04-amd64-server-*"},
	...
	*/
	"amazon.oman.1":  {"amazon.oman.1", "t3.large", "ubuntu/images/hvm-ssd/ubuntu-jammy-22.04-amd64-server-*"},
