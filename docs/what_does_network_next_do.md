...
Data from more than 25M unique players through Network Next shows that at any time at 5-10% of players are experiencing degraded network performance. This is true no matter where you host your game servers. In cloud, bare metal, even if that network provider claims to have the best network in the world. This bad network performance moves around, affecting up to 90% of your players every month.
