...
3. This job uploads the results of the build (the artifacts) to the google cloud storage bucket named "<your_company_name>_network_next_backend_artifacts" in the "Storage" project under a subdirectory with your tag name.
